 ...
 * @return {object} (ip4ip6addresses) - An IPv4 and IPv6 address object.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  let v4v6Addresses = {ipv4: null, ipv6: null};
  ...
  if (!cidr.isValid()) {
    ...
    v4v6Addresses.ipv4 = firstIpAddress;
    v4v6Addresses.ipv6 = getIpv4MappedIpv6Address(firstIpAddress);
  }
  ...
  return callback(v4v6Addresses, callbackError);
}
